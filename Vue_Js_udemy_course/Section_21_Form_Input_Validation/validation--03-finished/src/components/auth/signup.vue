...
<script>
  ...
  export default {
    ...
    //validations has to binded to named data, named html tags!
    validations: {
      email: {
        required,
        email,
      ...
      //vm stands for the vueInstace of the template
      //So we are accessing the password property of it
      //and sameAs() function will check it for us
      confirmPassword: {
